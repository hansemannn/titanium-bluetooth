...
public interface OnPeripheralConnectionStateChangedListener {
    void onPeripheralConnectionStateConnected(TiBluetoothPeripheralProxy peripheral);
    void onPeripheralConnectionStateDisconnected(TiBluetoothPeripheralProxy peripheral);
