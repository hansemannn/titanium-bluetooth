...
#else
MAKE_SYSTEM_PROP(MANAGER_STATE_UNKNOWN, CBCentralManagerStateUnknown);
MAKE_SYSTEM_PROP(MANAGER_STATE_RESETTING, CBCentralManagerStateResetting);
MAKE_SYSTEM_PROP(MANAGER_STATE_UNSUPPORTED, CBCentralManagerStateUnsupported);
MAKE_SYSTEM_PROP(MANAGER_STATE_UNAUTHORIZED, CBCentralManagerStateUnauthorized);
MAKE_SYSTEM_PROP(MANAGER_STATE_POWERED_OFF, CBCentralManagerStatePoweredOff);
MAKE_SYSTEM_PROP(MANAGER_STATE_POWERED_ON, CBCentralManagerStatePoweredOn);
#endif
...
MAKE_SYSTEM_PROP(CHARACTERISTIC_PROPERTY_NOTIFY_ENCRYPTION_REQUIRED, CBCharacteristicPropertyNotifyEncryptionRequired);
